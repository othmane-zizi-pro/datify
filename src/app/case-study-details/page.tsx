...
export const metadata: Metadata = {
  title: "Case Study Details | Your Company Name",
  description: "Detailed view of our client success stories and project outcomes",
};
            ...
            <div className="w-full px-4 lg:w-8/12">
              <div>
                <h2 className="mb-8 text-3xl font-bold leading-tight text-black dark:text-white sm:text-4xl sm:leading-tight">
                  Digital Transformation for Global Retail Chain
                </h2>
                    ...
                    <div className="mb-5 mr-10 flex items-center">
                      <div className="mr-4">
                        <div className="relative h-10 w-10 overflow-hidden rounded-full">
                          <Image
                            src="/images/case-studies/company-logos/retail-co.png"
                            alt="company logo"
                            fill
                          />
                        </div>
                      ...
                      <div className="w-full">
                        <span className="mb-1 text-base font-medium text-body-color">
                          Client: <span>Global Retail Co</span>
                        </span>
                      </div>
                    </div>
                ...
                <div>
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    How we helped a major retail chain modernize their digital infrastructure and increase online sales by 150%
                  </p>
                  <div className="mb-10 w-full overflow-hidden rounded">
                    <div className="relative aspect-[97/60] w-full sm:aspect-[97/44]">
                      <Image
                        src="/images/case-studies/retail-transformation.jpg"
                        alt="image"
                        fill
                  ...
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    The client needed to modernize their legacy systems and create a seamless omnichannel experience for customers. Their existing infrastructure was built on outdated technology that was becoming increasingly expensive to maintain and couldn't support modern e-commerce features. Customer satisfaction was declining as competitors offered more convenient shopping experiences.
                  </p>
                  ...
                  <p className="mb-8 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    We implemented a modern microservices architecture and developed a new mobile-first e-commerce platform. Our approach included:
                  </p>
                  <ul className="mb-10 list-inside list-disc text-body-color">
                    ...
                    <li className="mb-2 text-base font-medium text-body-color sm:text-lg lg:text-base xl:text-lg">
                      Developing a responsive, mobile-first e-commerce platform
                    </li>
                    <li className="mb-2 text-base font-medium text-body-color sm:text-lg lg:text-base xl:text-lg">
                      Implementing a unified inventory system across online and physical stores
                    </li>
                    <li className="mb-2 text-base font-medium text-body-color sm:text-lg lg:text-base xl:text-lg">
                      Creating a personalized recommendation engine using customer data
                    </li>
                    <li className="mb-2 text-base font-medium text-body-color sm:text-lg lg:text-base xl:text-lg">
                      Integrating a modern payment processing system with multiple options
                    </li>
                  </ul>
                  ...
                  <div className="relative z-10 mb-10 overflow-hidden rounded-md bg-primary bg-opacity-10 p-8 md:p-9 lg:p-8 xl:p-9">
                    <p className="text-center text-base font-medium text-body-color">
                      Our digital transformation project delivered exceptional results for Global Retail Co:
                    </p>
                    <ul className="mt-4 list-inside list-disc text-body-color">
                      <li className="mb-2 text-base font-medium text-body-color sm:text-lg lg:text-base xl:text-lg">
                        <strong>150% increase in online sales</strong> within the first year after launch
                      </li>
                      <li className="mb-2 text-base font-medium text-body-color sm:text-lg lg:text-base xl:text-lg">
                        <strong>40% improvement in customer satisfaction</strong> scores
                      </li>
                      <li className="mb-2 text-base font-medium text-body-color sm:text-lg lg:text-base xl:text-lg">
                        <strong>60% reduction in system maintenance costs</strong> through modern cloud infrastructure
                      </li>
                    </ul>
                  ...
                  <div className="items-center justify-between sm:flex">
                    <div className="mb-5">
                      ...
                      <div className="flex items-center">
                        <TagButton text="Digital Transformation" />
                        <TagButton text="E-commerce" />
                        <TagButton text="Retail" />
                      </div>
                    </div>
                    <div className="mb-5">
                ...
                <div className="mb-12 rounded-md bg-primary bg-opacity-5 p-6 dark:bg-opacity-5 lg:mb-10">
                  ...
                  <div className="mb-7 flex items-center">
                    <div className="mr-4 h-[70px] w-full max-w-[70px] overflow-hidden rounded-md">
                      <Image
                        src="/images/case-studies/ai-customer-service.jpg"
                        alt="image"
                        width={70}
                        height={70}
                    ...
                    <div>
                      ...
                      <p className="text-xs text-body-color">Technology</p>
                    </div>
                  </div>
                  <div className="mb-7 flex items-center">
                    <div className="mr-4 h-[70px] w-full max-w-[70px] overflow-hidden rounded-md">
                      <Image
                        src="/images/case-studies/healthcare-analytics.jpg"
                        alt="image"
                        width={70}
                        height={70}
                        className="h-full w-full object-cover object-center"
                    ...
                    <div>
                      ...
                      <p className="text-xs text-body-color">Healthcare</p>
                    </div>
                  </div>
                </div>

                <div className="mb-12 rounded-md bg-primary bg-opacity-5 p-6 dark:bg-opacity-5">
                  ...
                  <Link
                    href="/contact"
                    className="inline-block rounded-md bg-primary px-8 py-4 text-base font-medium text-white transition hover:bg-opacity-90"
                  >
